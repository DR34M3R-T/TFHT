...
# 导入raw数据集
data_train = torch.from_numpy(np.load('./dataset/CWRU/data.npy'))
label_train = torch.from_numpy(np.load('./dataset/CWRU/relabel.npy'))
data_test = torch.from_numpy(np.load('./dataset/CWRU/data.npy'))
lable_test = torch.from_numpy(np.load('./dataset/CWRU/relabel.npy'))
